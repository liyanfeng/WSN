...
#define       PIN_OUT       (P0DIR |= 0x80)
#define       PIN_IN        (P0DIR &= ~0x80)
#define       PIN_CLR       (P0_7 = 0)
#define       PIN_SET       (P0_7 = 1)
#define       PIN_R         (P0_7)
...
extern void DelaymS (unsigned int dly);
